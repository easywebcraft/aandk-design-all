...
BASE_URL = "https://easywebcraft.github.io/aandk-design-all"
...
PAGES = {
    "index.html": {
        "src": "design-all.html",
        "desc": "株式会社 A and K さま向け、3つのサイトのデザイン案です。"
                "保育園サイトと放課後等デイサイトを3案ずつ、"
                "コーポレートサイト aandkcorp.com を2案、まとめてご覧いただけます。",
        "links": {},
    },
}
